...
const PATH_SECTIONS = [
  ...
  },
  {
    ...
    lessons: ['primer-02', 'primer-03', 'primer-04', 'primer-05', 'primer-06', 'primer-07', 'primer-08'],
  },
  {
    title: '📐 문장 만들기',
    color: '#5B21B6',
    subtitle: '절대분사(~하고 나서) · 부정사(~하기 위해) · 중성명사 · 동사 현재형',
    lessons: ['primer-09', 'primer-10', 'primer-11', 'primer-12', 'primer-13'],
  },
  {
    title: '🪷 행복경 독해',
  ...
  },
  {
    ...
    lessons: ['primer-23', 'primer-24', 'primer-25', 'primer-26', 'primer-27', 'primer-28', 'primer-29'],
  },
  {
    title: '🔍 무아경 독해',
    color: '#7C3AED',
  ...
  },
  {
    ...
    lessons: ['primer-30', 'primer-31', 'primer-32', 'primer-extra'],
  },
  {
    title: '🧘 사념처경 독해',
    color: '#7C3AED',
...
const GRAMMAR_SECTIONS = [
  ...
  },
  {
    ...
    icon: '📐',
    items: [
      { label: '목적격: ~을/를 (naraṃ, deve)', lesson: 'primer-02', status: '명사' },
      { label: '구격: ~에 의해, ~(으)로 (narena)', lesson: 'primer-03', status: '명사' },
      { label: '여격·탈격: ~에게, ~로부터 (narassa, narā)', lesson: 'primer-04', status: '명사' },
      { label: '소유격: ~의 (narassa)', lesson: 'primer-05', status: '명사' },
      { label: '처소격: ~에서 (nare, naresu)', lesson: 'primer-06', status: '명사' },
      { label: '호격: ~이여 (nara, bhikkhave)', lesson: 'primer-07', status: '명사' },
      { label: '전체 격변화 정리 (단수+복수)', lesson: 'primer-08', status: '명사' },
    ],
  },
  {
    title: '문장 만들기',
    ...
    items: [
      ...
      { label: '동사 현재형 (viharati, gacchati)', lesson: 'primer-12', status: '동사' },
      { label: '특수 동사 (atthi=있다, karoti=하다)', lesson: 'primer-13', status: '동사' },
    ],
  },
  {
    title: '🪷 행복경 독해',
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'u-어간 여성명사 (dhātu=요소)', lesson: 'primer-24', status: '명사' },
      { label: 'i-어간 남성명사 (aggi=불)', lesson: 'primer-25', status: '명사' },
      { label: 'ī-어간 명사 (nadī=강, senānī=장수)', lesson: 'primer-26', status: '명사' },
      { label: 'u/ū-어간 남성명사 (bhikkhu=비구)', lesson: 'primer-27', status: '명사' },
      { label: '자음어간 명사 (satthā=스승, mātā=어머니)', lesson: 'primer-28', status: '명사' },
      { label: 'i/u-어간 중성명사 (akkhi=눈)', lesson: 'primer-29', status: '명사' },
    ],
  },
  {
    title: '🔍 무아경 독해',
  ...
  },
  {
    ...
    icon: '📐',
    items: [
      { label: '형용사 격변화 (-vantu/-mantu)', lesson: 'primer-30', status: '문법' },
      { label: '인칭 대명사 (ahaṃ=나, tvaṃ=너)', lesson: 'primer-31', status: '문법' },
      { label: '지시·관계·의문 대명사 (so, yo, ko, sabba)', lesson: 'primer-32', status: '문법' },
      { label: '복합어: 여러 단어가 하나로', lesson: 'primer-extra', status: '문법' },
      { label: '접두사 (a-=부정, sam-=함께)', lesson: 'primer-extra', status: '문법' },
      { label: '접미사 (-tā=추상, -ka=행위자)', lesson: 'primer-extra', status: '문법' },
      { label: '수사 (eka=1, dvi=2, cattāri=4)', lesson: 'primer-extra', status: '문법' },
      { label: '연성법 상세 (단어가 합쳐지는 규칙)', lesson: 'primer-extra', status: '문법' },
      { label: '격변화·동사 총정리', lesson: 'primer-extra', status: '문법' },
    ],
  },
  {
    title: '★ 사념처경 실전',
