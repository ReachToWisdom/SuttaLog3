...
export const VERSE_1 = {
  ...
  grammarNotes: [
    ...
    '조격(tatiyadivibhatti) 용법: manasā paduṭṭhena — "더러운 마음으로(수단)" 조격이 행위의 수단/도구를 나타냄',
  ],
}
...
export const VERSE_1_WORDS: VerseWord[] = [
  ...
  { pali: 'manasā', pronKo: '마나사-', meaning: '마음으로', grammar: '중성 단수 조격 (manas)' },
  { pali: 'ce', pronKo: '쩨', meaning: '만약', grammar: '불변어(접속사)' },
  { pali: 'paduṭṭhena', pronKo: '빠둣테나', meaning: '더러운/오염된', grammar: '과거분사 중성 단수 조격 (pa + dussati)' },
...
export const VERSE_2 = {
  ...
  grammarNotes: [
    ...
    'pasannena: pa+sīdati(가라앉다→맑아지다)의 과거분사 pasanna의 조격. manasā와 성·수·격 일치(중성 단수 조격)',
...
export const VERSE_2_WORDS: VerseWord[] = [
  { pali: 'pasannena', pronKo: '빠산네나', meaning: '맑은/청정한', grammar: '과거분사 중성 단수 조격 (pa + sīdati)' },
...
export const VERSE_3 = {
  ...
  grammarNotes: [
    '문장 구조: 1행은 부정(na)+조격(verena)+주어(verāni)+동사(sammanti) — "수단의 조격"으로 원한이라는 수단을 표현',
    '연성: sammanti+idha → sammantīdha — 동사 어미 -i와 idha의 i-가 합쳐 장모음 -ī. na...kudācanaṃ 이중부정으로 "결코~않다" 강조',
    '대구법: 1행 verena(조격) ↔ 2행 averena(조격) — 접두사 a-(부정)만 추가하여 의미를 완전히 반전. 동사 sammanti 동일',
...
export const VERSE_3_WORDS: VerseWord[] = [
  ...
  { pali: 'verena', pronKo: '웨레나', meaning: '원한으로', grammar: '중성 단수 조격 (vera)' },
  ...
  { pali: 'averena', pronKo: '아웨레나', meaning: '원한 없음으로', grammar: '중성 단수 조격 (a + vera)' },
...
export const VERSE_6 = {
  ...
  grammarNotes: [
    ...
    '재귀대명사 attan: attā(주격), attano(소유격), attanā(조격) — 한 게송 안에 3가지 격변화가 모두 등장하여 attan 변화 학습에 유용',
    '복합어: su+danta(잘+길들여진) — 접두사 su-(좋은/잘)와 과거분사 danta(dameti에서)의 결합. du+labha(어렵게+얻는) — 접두사 du-(어려운)와 labha의 결합',
    '조격의 조건적 용법: attanā sudantena "잘 다스려진 자신으로써" — 조격이 조건("~하면")의 의미로 사용됨. 주어가 생략되어 있음(자기 자신이)',
  ],
}
...
export const VERSE_6_WORDS: VerseWord[] = [
  ...
  { pali: 'attanā', pronKo: '앗따나-', meaning: '자기 자신으로', grammar: '재귀대명사 단수 조격' },
  { pali: 'sudantena', pronKo: '수단떼나', meaning: '잘 다스려진', grammar: '과거분사 남성 단수 조격 (su + danta)' },
...
export const VERSE_9 = {
  ...
  grammarNotes: [
    ...
    '조격(수단)+목적격(대상) 4쌍 병렬: akkodhena→kodhaṃ, sādhunā→asādhuṃ, dānena→kadariyaṃ, saccena→alikavādinaṃ — "A로써 B를 이겨라" 패턴 반복',
...
export const VERSE_9_WORDS: VerseWord[] = [
  { pali: 'Akkodhena', pronKo: '악코데나', meaning: '성내지 않음으로', grammar: '남성 단수 조격 (a + kodha)' },
  ...
  { pali: 'sādhunā', pronKo: '사-두나-', meaning: '선으로/착함으로', grammar: '중성 단수 조격' },
  { pali: 'kadariyaṃ', pronKo: '까다리양', meaning: '인색한 자를', grammar: '형용사 남성 단수 목적격' },
  { pali: 'dānena', pronKo: '다-네나', meaning: '보시로', grammar: '중성 단수 조격' },
  { pali: 'saccenālikavādinaṃ', pronKo: '삿쩨나-리까와-디낭', meaning: '진실로 + 거짓말하는 자를', grammar: '중성 단수 조격 + 남성 단수 목적격 (sacca + alika + vādin, 연성)' },
]
...
export const VERSE_10 = {
  ...
  grammarNotes: [
    ...
    '조격(paññāya): paññā(지혜)의 여성 단수 조격 — 수단/도구의 조격 "지혜로써". 처격(dukkhe): dukkha의 중성 단수 처격 — "괴로움에 대해" 대상의 처격',
...
export const VERSE_10_WORDS: VerseWord[] = [
  ...
  { pali: 'paññāya', pronKo: '빤냐-야', meaning: '지혜로', grammar: '여성 단수 조격 (paññā)' },
