...
export const VERSE_2 = {
  ...
  grammarNotes: [
    '수동 구문: 행위자(pabbajitena, 도구격) + 부정(na) + 미래수동분사(sevitabbā). 의무/당위를 나타냄',
...
export const VERSE_2_WORDS: VerseWord[] = [
  ...
  { pali: 'pabbajitena', pronKo: '빱바지떼나', meaning: '출가자에 의해', grammar: '과거분사 남성 단수 도구격' },
...
export const VERSE_3 = {
  ...
  grammarNotes: [
    ...
    '간접목적격 연쇄: upasamāya, abhiññāya, sambodhāya, nibbānāya — 목적/방향의 간접목적격 4개 병렬',
...
export const VERSE_3_WORDS: VerseWord[] = [
  ...
  { pali: 'tathāgatena', pronKo: '따타-가떼나', meaning: '여래에 의해', grammar: '남성 단수 도구격' },
  ...
  { pali: 'upasamāya', pronKo: '우빠사마-야', meaning: '고요함을 위해', grammar: '남성 단수 간접목적격' },
  { pali: 'abhiññāya', pronKo: '아빈냐-야', meaning: '뛰어난 앎을 위해', grammar: '여성 단수 간접목적격' },
  { pali: 'sambodhāya', pronKo: '삼보다-야', meaning: '깨달음을 위해', grammar: '여성 단수 간접목적격' },
  { pali: 'nibbānāya', pronKo: '닙바-나-야', meaning: '열반을 위해', grammar: '중성 단수 간접목적격', important: true },
...
export const VERSE_5_WORDS: VerseWord[] = [
  ...
  { pali: 'appiyehi', pronKo: '앞삐예히', meaning: '좋아하지 않는 것들과', grammar: '형용사 남성 복수 도구격 (a + piya)' },
  { pali: 'sampayogo', pronKo: '삼빠요고', meaning: '만남/결합', grammar: '남성 단수 주격' },
  { pali: 'piyehi', pronKo: '삐예히', meaning: '좋아하는 것들과', grammar: '형용사 남성 복수 도구격' },
  ...
  { pali: 'saṅkhittena', pronKo: '상킷떼나', meaning: '요약하면', grammar: '과거분사 중성 단수 도구격 (saṃ + khipati)' },
...
export const VERSE_9_WORDS: VerseWord[] = [
  ...
  { pali: 'me', pronKo: '메', meaning: '나에게', grammar: '인칭대명사 1인칭 단수 간접목적격' },
...
export const VERSE_13_WORDS: VerseWord[] = [
  ...
  { pali: 'sassamaṇabrāhmaṇiyā', pronKo: '삿사마나브라-마니야-', meaning: '사문과 바라문을 포함한', grammar: '형용사 여성 단수 도구격' },
  { pali: 'pajāya', pronKo: '빠자-야', meaning: '무리/인류의', grammar: '여성 단수 도구격' },
  { pali: 'sadevamanussāya', pronKo: '사데와마눗사-야', meaning: '천신과 인간을 포함한', grammar: '형용사 여성 단수 도구격' },
