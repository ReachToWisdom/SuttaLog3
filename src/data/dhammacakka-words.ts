...
export const VERSE_1 = {
  ...
  grammarNotes: [
    '정형구: "Ekaṃ samayaṃ bhagavā ... viharati"는 경전 서두의 고정 형식(nidāna). ekaṃ samayaṃ은 시간 대격(Accusative of time)',
    '처격 연쇄: bārāṇasiyaṃ → isipatane → migadāye. 넓은 장소에서 좁은 장소로 좁혀가는 처격 구문',
    'āmantesi: ā + manteti의 과거형. pañcavaggiye bhikkhū는 대격으로 말씀의 대상',
  ],
}
...
export const VERSE_1_WORDS: VerseWord[] = [
  ...
  { pali: 'pañcavaggiye', pronKo: '빤짜왁기예', meaning: '다섯 무리의', grammar: '형용사 남성 복수 대격 (pañca + vagga + iya)' },
...
export const VERSE_7 = {
  ...
  grammarNotes: [
    '속격 구문: tassāyeva = tassā + eva("바로 그것의"). taṇhāya(여성 속격)',
...
export const VERSE_13_WORDS: VerseWord[] = [
  ...
  { pali: 'tiparivaṭṭaṃ', pronKo: '띠빠리왓땅', meaning: '삼전(세 번 돌림)', grammar: '중성 단수 대격 (ti + parivaṭṭa)', important: true },
  { pali: 'dvādasākāraṃ', pronKo: '드와-다사-까-랑', meaning: '십이행상(열두 양상)', grammar: '중성 단수 대격 (dvādasa + ākāra)', important: true },
  ...
  { pali: 'anuttaraṃ', pronKo: '아눗따랑', meaning: '위없는/최상의', grammar: '형용사 여성 단수 대격 (an + uttara)', important: true },
  { pali: 'sammāsambodhiṃ', pronKo: '삼마-삼보딩', meaning: '바른 완전한 깨달음을', grammar: '여성 단수 대격 (sammā + sam + bodhi)', important: true },
...
export const VERSE_15 = {
  ...
  grammarNotes: [
    ...
    '속격 소유구문: āyasmato koṇḍaññassa(속격) + dhammacakkhuṃ(주격) + udapādi',
...
export const VERSE_15_WORDS: VerseWord[] = [
  ...
  { pali: 'bhagavato', pronKo: '바가와또', meaning: '세존의', grammar: '남성 단수 속격' },
  { pali: 'bhāsitaṃ', pronKo: '바-시땅', meaning: '말씀하신 것을', grammar: '과거분사 중성 단수 대격 (bhāsati)' },
