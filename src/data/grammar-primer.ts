...
export const PRIMER_GRAMMAR: TeachGrammarStep[] = [
...

  {
    ...
    examples: [
      ...
      { pali: 'buddhaṃ', breakdown: 'buddha + aṃ', meaning: '붓다를 (대격)', highlight: 'aṃ' },
      { pali: 'buddhena', breakdown: 'buddha + ena', meaning: '붓다에 의해 (구격)', highlight: 'ena' },
      { pali: 'buddhassa', breakdown: 'buddha + ssa', meaning: '붓다의 (속격)', highlight: 'ssa' },
    ],
    table: {
      label: 'a-어간 남성 명사 단수',
      rows: [
        { case: '주격 (nom.)', ending: '-o', example: 'buddho', meaning: '~이/가' },
        { case: '대격 (acc.)', ending: '-aṃ', example: 'buddhaṃ', meaning: '~을/를' },
        { case: '구격 (ins.)', ending: '-ena', example: 'buddhena', meaning: '~에 의해' },
        { case: '여격 (dat.)', ending: '-āya/-ssa', example: 'buddhāya', meaning: '~에게' },
        { case: '탈격 (abl.)', ending: '-ā/-mhā/-smā', example: 'buddhā', meaning: '~로부터' },
        { case: '속격 (gen.)', ending: '-ssa', example: 'buddhassa', meaning: '~의' },
...

  {
    ...
    description: '복수형도 규칙적. 주격 -ā, 대격 -e 를 먼저 익히세요.',
    examples: [
      { pali: 'buddhā', breakdown: 'buddha + ā', meaning: '붓다들이 (주격)', highlight: 'ā' },
      { pali: 'buddhe', breakdown: 'buddha + e', meaning: '붓다들을 (대격)', highlight: 'e' },
      { pali: 'buddhehi', breakdown: 'buddha + ehi', meaning: '붓다들에 의해 (구격)', highlight: 'ehi' },
      { pali: 'buddhānaṃ', breakdown: 'buddha + ānaṃ', meaning: '붓다들의 (속격)', highlight: 'ānaṃ' },
    ],
    table: {
      label: 'a-어간 남성 명사 복수',
      rows: [
        { case: '주격 (nom.)', ending: '-ā', example: 'buddhā', meaning: '~들이' },
        { case: '대격 (acc.)', ending: '-e', example: 'buddhe', meaning: '~들을' },
        { case: '구격 (ins.)', ending: '-ehi/-ebhi', example: 'buddhehi', meaning: '~들에 의해' },
        { case: '여격 (dat.)', ending: '-ānaṃ', example: 'buddhānaṃ', meaning: '~들에게' },
        { case: '탈격 (abl.)', ending: '-ehi/-ebhi', example: 'buddhehi', meaning: '~들로부터' },
        { case: '속격 (gen.)', ending: '-ānaṃ', example: 'buddhānaṃ', meaning: '~들의' },
        { case: '처격 (loc.)', ending: '-esu', example: 'buddhesu', meaning: '~들에서' },
        { case: '호격 (voc.)', ending: '= 주격', example: 'buddhā', meaning: '~들이여' },
      ],
    },
    tip: '복수 여격과 속격은 둘 다 -ānaṃ (같은 형태)',
    relatedLesson: 'Primer Lesson 2',
  },
...

  {
    ...
    description:
      '남성과 거의 같지만 주격/대격/호격만 다르다. 중성은 주격 = 대격이 항상 같다!',
    examples: [
      { pali: 'cittaṃ', breakdown: 'citta + aṃ', meaning: '마음이/마음을 (주격=대격)', highlight: 'aṃ' },
...

  {
    ...
    description: '복수에서도 주격 = 대격. 어미 -āni로 끝남. 나머지는 남성 복수와 동일.',
    examples: [
      { pali: 'cittāni', breakdown: 'citta + āni', meaning: '마음들이/마음들을 (주격=대격)', highlight: 'āni' },
...

  {
    ...
    description:
      '-ā로 끝나는 여성 명사. 구격~처격이 대부분 -āya로 동일한 것이 특징.',
    examples: [
      { pali: 'paññā', breakdown: 'paññ + ā', meaning: '지혜가 (주격)', highlight: 'ā' },
      { pali: 'paññaṃ', breakdown: 'paññ + aṃ', meaning: '지혜를 (대격)', highlight: 'aṃ' },
    ...
    table: {
      ...
      rows: [
        ...
        { case: '대격 (acc.)', ending: '-aṃ', example: 'paññaṃ', meaning: '~을/를' },
...

  {
    ...
    description: '복수 주격/대격은 -ā 또는 -āyo 두 형태 모두 사용.',
    examples: [
      ...
      { pali: 'paññānaṃ', breakdown: 'paññ + ānaṃ', meaning: '지혜들의 (속격)', highlight: 'ānaṃ' },
    ],
    table: {
      label: 'ā-어간 여성 명사 복수',
      rows: [
        { case: '주격 (nom.)', ending: '-ā/-āyo', example: 'paññā', meaning: '~들이' },
        { case: '대격 (acc.)', ending: '-ā/-āyo', example: 'paññāyo', meaning: '~들을' },
...

  {
    ...
    examples: [
      ...
      { pali: 'mahantaṃ buddhaṃ', breakdown: 'mahant + aṃ buddha + aṃ', meaning: '위대한 붓다를 (남성 대격 단수)', highlight: 'aṃ' },
...

  {
    ...
    title: 'i-어간 남성/중성 명사',
    description:
      '-i로 끝나는 명사. 남성과 중성은 a-어간처럼 주격/대격만 다르다.',
    examples: [
      { pali: 'aggi', breakdown: 'aggi (어간)', meaning: '불이 (남성 주격)', highlight: 'i' },
      { pali: 'aggiṃ', breakdown: 'agg + iṃ', meaning: '불을 (대격)', highlight: 'iṃ' },
      { pali: 'agginā', breakdown: 'agg + inā', meaning: '불에 의해 (구격)', highlight: 'inā' },
    ...
    table: {
      ...
      rows: [
        ...
        { case: '대격 (acc.)', ending: '-iṃ', example: 'aggiṃ', meaning: '~을/를' },
...

  {
    ...
    title: 'i-어간 여성 명사',
    description:
      '-i로 끝나는 여성 명사. 구격~속격이 대부분 -iyā로 동일.',
    examples: [
      { pali: 'bhūmi', breakdown: 'bhūmi (어간)', meaning: '땅이 (주격)', highlight: 'i' },
      { pali: 'bhūmiṃ', breakdown: 'bhūm + iṃ', meaning: '땅을 (대격)', highlight: 'iṃ' },
    ...
    table: {
      ...
      rows: [
        ...
        { case: '대격 (acc.)', ending: '-iṃ', example: 'bhūmiṃ', meaning: '~을/를' },
...

  {
    ...
    examples: [
      ...
      { pali: 'bhikkhuṃ', breakdown: 'bhikkh + uṃ', meaning: '비구를 (대격)', highlight: 'uṃ' },
      { pali: 'bhikkhunā', breakdown: 'bhikkh + unā', meaning: '비구에 의해 (구격)', highlight: 'unā' },
      { pali: 'bhikkhussa', breakdown: 'bhikkh + ussa', meaning: '비구의 (속격)', highlight: 'ussa' },
    ],
    table: {
      label: 'u-어간 남성 명사 단수',
      rows: [
        { case: '주격 (nom.)', ending: '-u', example: 'bhikkhu', meaning: '~이/가' },
        { case: '대격 (acc.)', ending: '-uṃ', example: 'bhikkhuṃ', meaning: '~을/를' },
        ...
        { case: '속격 (gen.)', ending: '-uno/-ussa', example: 'bhikkhuno', meaning: '~의' },
...

  {
    ...
    examples: [
      ...
      { pali: 'dhātuṃ', breakdown: 'dhāt + uṃ', meaning: '요소를 (대격)', highlight: 'uṃ' },
    ...
    table: {
      ...
      rows: [
        ...
        { case: '대격 (acc.)', ending: '-uṃ', example: 'dhātuṃ', meaning: '~을/를' },
