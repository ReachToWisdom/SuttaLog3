...
export const PRIMER_GRAMMAR: TeachGrammarStep[] = [
...

  {
    ...
    table: {
      ...
      rows: [
        ...
        { case: '간접목적격 (dat.)', ending: '-āya/-ssa', example: 'buddhāya', meaning: '~에게' },
        { case: '분리격 (abl.)', ending: '-ā/-mhā/-smā', example: 'buddhā', meaning: '~로부터' },
        { case: '소유격 (gen.)', ending: '-ssa', example: 'buddhassa', meaning: '~의' },
        { case: '처격 (loc.)', ending: '-e/-mhi/-smiṃ', example: 'buddhe', meaning: '~에서' },
        { case: '부름격 (voc.)', ending: '= 어간', example: 'buddha', meaning: '~이여' },
      ],
    },
    tip: '-o로 끝나면 남성 주격 단수',
...

  {
    ...
    table: {
      ...
      rows: [
        ...
        { case: '간접목적격 (dat.)', ending: '-ānaṃ', example: 'buddhānaṃ', meaning: '~들에게' },
        { case: '분리격 (abl.)', ending: '-ehi/-ebhi', example: 'buddhehi', meaning: '~들로부터' },
        { case: '소유격 (gen.)', ending: '-ānaṃ', example: 'buddhānaṃ', meaning: '~들의' },
        { case: '처격 (loc.)', ending: '-esu', example: 'buddhesu', meaning: '~들에서' },
        { case: '부름격 (voc.)', ending: '= 주격', example: 'buddhā', meaning: '~들이여' },
      ],
    },
    tip: '복수 간접목적격과 소유격은 둘 다 -ānaṃ (같은 형태)',
    relatedLesson: 'Primer Lesson 2',
  },
...

  {
    ...
    description:
      '남성과 거의 같지만 주격/목적격/부름격만 다르다. 중성은 주격 = 목적격이 항상 같다!',
    examples: [
    ...
    table: {
      ...
      rows: [
        ...
        { case: '간접목적격 (dat.)', ending: '-āya/-ssa', example: 'cittassa', meaning: '~에게' },
        { case: '분리격 (abl.)', ending: '-ā/-mhā/-smā', example: 'cittā', meaning: '~로부터' },
        { case: '소유격 (gen.)', ending: '-ssa', example: 'cittassa', meaning: '~의' },
        { case: '처격 (loc.)', ending: '-e/-mhi/-smiṃ', example: 'citte', meaning: '~에서' },
        { case: '부름격 (voc.)', ending: '-aṃ / 어간', example: 'cittaṃ', meaning: '~이여' },
      ],
    },
...

  {
    ...
    table: {
      ...
      rows: [
        ...
        { case: '간접목적격 (dat.)', ending: '-ānaṃ', example: 'cittānaṃ', meaning: '~들에게' },
        { case: '분리격 (abl.)', ending: '-ehi/-ebhi', example: 'cittehi', meaning: '~들로부터' },
        { case: '소유격 (gen.)', ending: '-ānaṃ', example: 'cittānaṃ', meaning: '~들의' },
        { case: '처격 (loc.)', ending: '-esu', example: 'cittesu', meaning: '~들에서' },
        { case: '부름격 (voc.)', ending: '-āni', example: 'cittāni', meaning: '~들이여' },
      ],
    },
    tip: '복수 주격/목적격/부름격 -āni, 나머지는 남성 복수와 완전히 같다',
    relatedLesson: 'Primer Lesson 4',
  },
...

  {
    ...
    examples: [
      ...
      { pali: 'paññe', breakdown: 'paññ + e', meaning: '지혜여 (부름격)', highlight: 'e' },
    ],
    table: {
      label: 'ā-어간 여성 명사 단수',
      rows: [
        ...
        { case: '간접목적격 (dat.)', ending: '-āya', example: 'paññāya', meaning: '~에게' },
        { case: '분리격 (abl.)', ending: '-āya', example: 'paññāya', meaning: '~로부터' },
        { case: '소유격 (gen.)', ending: '-āya', example: 'paññāya', meaning: '~의' },
        { case: '처격 (loc.)', ending: '-āya/-āyaṃ', example: 'paññāyaṃ', meaning: '~에서' },
        { case: '부름격 (voc.)', ending: '-e', example: 'paññe', meaning: '~이여' },
      ],
    },
...

  {
    ...
    table: {
      ...
      rows: [
        ...
        { case: '간접목적격 (dat.)', ending: '-ānaṃ', example: 'paññānaṃ', meaning: '~들에게' },
        { case: '분리격 (abl.)', ending: '-āhi', example: 'paññāhi', meaning: '~들로부터' },
        { case: '소유격 (gen.)', ending: '-ānaṃ', example: 'paññānaṃ', meaning: '~들의' },
        { case: '처격 (loc.)', ending: '-āsu', example: 'paññāsu', meaning: '~들에서' },
        { case: '부름격 (voc.)', ending: '= 주격', example: 'paññā', meaning: '~들이여' },
      ],
    },
    tip: '여성 복수 도구격/분리격 -āhi, 처격 -āsu — 남성 -ehi/-esu와 비교!',
    relatedLesson: 'Primer Lesson 5',
  },
...

  {
    ...
    table: {
      ...
      rows: [
        ...
        { case: '간접목적격 (dat.)', ending: '-ino/-issa', example: 'aggissa', meaning: '~에게' },
        { case: '분리격 (abl.)', ending: '-inā/-imhā/-ismā', example: 'agginā', meaning: '~로부터' },
        { case: '소유격 (gen.)', ending: '-ino/-issa', example: 'aggino', meaning: '~의' },
        { case: '처격 (loc.)', ending: '-imhi/-ismiṃ', example: 'aggimhi', meaning: '~에서' },
        { case: '부름격 (voc.)', ending: '-i', example: 'aggi', meaning: '~이여' },
      ],
    },
...

  {
    ...
    table: {
      ...
      rows: [
        ...
        { case: '간접목적격 (dat.)', ending: '-iyā', example: 'bhūmiyā', meaning: '~에게' },
        { case: '분리격 (abl.)', ending: '-iyā', example: 'bhūmiyā', meaning: '~로부터' },
        { case: '소유격 (gen.)', ending: '-iyā', example: 'bhūmiyā', meaning: '~의' },
        { case: '처격 (loc.)', ending: '-iyā/-iyaṃ', example: 'bhūmiyaṃ', meaning: '~에서' },
        { case: '부름격 (voc.)', ending: '-i', example: 'bhūmi', meaning: '~이여' },
      ],
    },
...

  {
    ...
    table: {
      ...
      rows: [
        ...
        { case: '간접목적격 (dat.)', ending: '-uno/-ussa', example: 'bhikkhussa', meaning: '~에게' },
        { case: '분리격 (abl.)', ending: '-unā/-umhā/-usmā', example: 'bhikkhunā', meaning: '~로부터' },
        { case: '소유격 (gen.)', ending: '-uno/-ussa', example: 'bhikkhuno', meaning: '~의' },
        { case: '처격 (loc.)', ending: '-umhi/-usmiṃ', example: 'bhikkhumhi', meaning: '~에서' },
        { case: '부름격 (voc.)', ending: '-u', example: 'bhikkhu', meaning: '~이여' },
      ],
    },
...

  {
    ...
    table: {
      ...
      rows: [
        ...
        { case: '간접목적격 (dat.)', ending: '-uyā', example: 'dhātuyā', meaning: '~에게' },
        { case: '분리격 (abl.)', ending: '-uyā', example: 'dhātuyā', meaning: '~로부터' },
        { case: '소유격 (gen.)', ending: '-uyā', example: 'dhātuyā', meaning: '~의' },
        { case: '처격 (loc.)', ending: '-uyā/-uyaṃ', example: 'dhātuyaṃ', meaning: '~에서' },
        { case: '부름격 (voc.)', ending: '-u', example: 'dhātu', meaning: '~이여' },
      ],
    },
