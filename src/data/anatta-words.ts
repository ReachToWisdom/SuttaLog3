...
export const VERSE_1_WORDS: VerseWord[] = [
  ...
  { pali: 'bhagavato', pronKo: '바가와또', meaning: '세존에게/세존의', grammar: '남성 단수 간접목적격/소유격' },
...
export const VERSE_2_WORDS: VerseWord[] = [
  ...
  { pali: 'bhikkhave', pronKo: '빅카웨', meaning: '비구들이여', grammar: '남성 복수 부름격', important: true },
  ...
  { pali: 'ābādhāya', pronKo: '아-바-다-야', meaning: '병들기 위해/병듦에', grammar: '남성 단수 간접목적격 (ābādha)' },
  ...
  { pali: 'Yasmā', pronKo: '야스마-', meaning: '~이므로', grammar: '관계대명사 분리격 (원인)' },
  { pali: 'tasmā', pronKo: '따스마-', meaning: '그러므로', grammar: '지시대명사 분리격 (결론)' },
...
export const VERSE_3_WORDS: VerseWord[] = [
  ...
  { pali: 'saṃvatteyya', pronKo: '상왓떼이야', meaning: '이끌 것이다', grammar: '가정법 3인칭 단수 (saṃvattati)' },
  { pali: 'labbhetha', pronKo: '랍베타', meaning: '얻어질 수 있어야 한다', grammar: '가정법 수동 3인칭 단수 (labhati)' },
  { pali: 'vedanāya', pronKo: '웨다나-야', meaning: '느낌에 대해', grammar: '여성 단수 처격/간접목적격' },
  { pali: 'evaṃ', pronKo: '에왕', meaning: '이와 같이', grammar: '불변어(부사)' },
  { pali: 'me', pronKo: '메', meaning: '나의', grammar: '1인칭 단수 소유격' },
  { pali: 'hotu', pronKo: '호뚜', meaning: '~이 되어라', grammar: '명령법 3인칭 단수 (bhavati)' },
  { pali: 'mā', pronKo: '마-', meaning: '~하지 말라', grammar: '불변어(금지사)' },
...
export const VERSE_4_WORDS: VerseWord[] = [
  ...
  { pali: 'saṃvatteyya', pronKo: '상왓떼이야', meaning: '이끌 것이다', grammar: '가정법 3인칭 단수 (saṃvattati)' },
  { pali: 'labbhetha', pronKo: '랍베타', meaning: '얻어질 수 있어야 한다', grammar: '가정법 수동 3인칭 단수 (labhati)' },
  { pali: 'saññāya', pronKo: '산냐-야', meaning: '인식에 대해', grammar: '여성 단수 처격/간접목적격' },
  { pali: 'evaṃ', pronKo: '에왕', meaning: '이와 같이', grammar: '불변어(부사)' },
  { pali: 'me', pronKo: '메', meaning: '나의', grammar: '1인칭 단수 소유격' },
  { pali: 'hotu', pronKo: '호뚜', meaning: '~이 되어라', grammar: '명령법 3인칭 단수 (bhavati)' },
  { pali: 'mā', pronKo: '마-', meaning: '~하지 말라', grammar: '불변어(금지사)' },
...
export const VERSE_7_WORDS: VerseWord[] = [
  ...
  { pali: 'bhante', pronKo: '반떼', meaning: '존자시여', grammar: '부름격 (공경어)' },
...
export const VERSE_13_WORDS: VerseWord[] = [
  ...
  { pali: 'virāgā', pronKo: '위라-가-', meaning: '이욕으로/탐욕 여읨으로', grammar: '남성 단수 분리격 (vi + rāga)', important: true },
  ...
  { pali: 'itthattāyāti', pronKo: '잇탓따-야-띠', meaning: '이런 상태로 + 라고', grammar: 'itthattāya(간접목적격) + iti (연성)' },
