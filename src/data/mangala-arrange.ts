...
export const ARRANGE_V0_WRITING = genWritingArrange(
  ...
  ['Evaṃ', 'me', 'sutaṃ'],
  [
    { text: 'mayā', why: 'mayā는 도구격(나에 의해)이지 주격이 아닙니다. 이 구문에서는 me가 맞습니다' },
...
export const ARRANGE_V2_READING = genReadingArrange(
  ...
  [
    { text: '어리석은 이에 의해', why: 'bālānaṃ은 소유격(~의/~을)이지 도구격(~에 의해)이 아닙니다' },
...
export const ARRANGE_V5_READING = genReadingArrange(
  ...
  [
    ...
    { text: '아내와 자녀에 의해', why: 'puttadārassa는 소유격(~의/~을)이지 도구격(~에 의해)이 아닙니다' },
  ],
)
...
export const ARRANGE_V8_READING = genReadingArrange(
  ...
  ['존경과', '겸손', '만족과', '감사함'],
  [
    { text: '존경에 의해', why: 'Gāravo는 주격(존경이)이지 도구격(존경에 의해)이 아닙니다' },
...
export const ARRANGE_V11_READING = genReadingArrange(
  ...
  [
    ...
    { text: '세상의 법을', why: 'lokadhammehi는 도구격(법에 의해/법에 부딪혀)이지 목적격이 아닙니다' },
...
export const ARRANGE_V11_WRITING = genWritingArrange(
  ...
  [
    ...
    { text: 'cittena', why: 'cittena는 도구격(마음에 의해)이지 주격이 아닙니다' },
