...
export const ARRANGE_V0_READING = genReadingArrange(
  ...
  [
    ...
    { text: '나의', why: 'me의 속격 해석이지만, 이 문장에서는 주격입니다' },
    { text: '들은 것을', why: 'sutaṃ은 여기서 주격(들은 것)이지 대격(들은 것을)이 아닙니다' },
  ],
)
...
export const ARRANGE_V0_WRITING = genWritingArrange(
  ...
  [
    ...
    { text: 'sutassa', why: 'sutassa는 속격(들은 것의)입니다. 여기서는 주격 sutaṃ이 맞습니다' },
...
export const ARRANGE_V1_READING_1 = genReadingArrange(
  ...
  ['많은', '천신들과', '인간들이'],
  [
    { text: '천신들의', why: 'devā는 주격(천신들이)이지 속격(천신들의)이 아닙니다' },
    { text: '인간들을', why: 'manussā는 주격(인간들이)이지 대격(인간들을)이 아닙니다' },
...
export const ARRANGE_V1_WRITING_1 = genWritingArrange(
  ...
  [
    ...
    { text: 'maṅgalassa', why: 'maṅgalassa는 속격(행복의)이지 대격이 아닙니다' },
  ],
)
...
export const ARRANGE_V2_READING = genReadingArrange(
  ...
  [
    { text: '어리석은 이에 의해', why: 'bālānaṃ은 속격(~의/~을)이지 구격(~에 의해)이 아닙니다' },
...
export const ARRANGE_V2_WRITING = genWritingArrange(
  ...
  ['Asevanā', 'ca', 'bālānaṃ', 'paṇḍitānañca', 'sevanā'],
  [
    { text: 'bālā', why: 'bālā는 주격(어리석은 이들이)이지만, 여기서는 속격 bālānaṃ이 맞습니다' },
    { text: 'paṇḍitā', why: 'paṇḍitā는 주격이지만, 여기서는 속격이 필요합니다' },
...
export const ARRANGE_V5_READING = genReadingArrange(
  ...
  [
    ...
    { text: '아내와 자녀에 의해', why: 'puttadārassa는 속격(~의/~을)이지 구격(~에 의해)이 아닙니다' },
  ],
)
...
export const ARRANGE_V8_READING = genReadingArrange(
  ...
  [
    ...
    { text: '만족을', why: 'santuṭṭhī는 주격(만족이)이지 대격(만족을)이 아닙니다' },
  ],
)
...
export const ARRANGE_V11_READING = genReadingArrange(
  ...
  [
    { text: '마음을', why: 'cittaṃ은 여기서 주격(마음이)이지 대격(마음을)이 아닙니다' },
    { text: '세상의 법을', why: 'lokadhammehi는 구격(법에 의해/법에 부딪혀)이지 대격이 아닙니다' },
...
export const ARRANGE_V11_WRITING = genWritingArrange(
  ...
  ['cittaṃ', 'na', 'kampati'],
  [
    { text: 'cittassa', why: 'cittassa는 속격(마음의)이지 주격(마음이)이 아닙니다' },
