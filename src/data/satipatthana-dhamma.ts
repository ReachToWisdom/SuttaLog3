...
export const VERSE_2_WORDS: VerseWord[] = [
  ...
  { pali: 'vā', pronKo: '와-', meaning: '또는', grammar: '불변어' },
  { pali: 'vedanāsu', pronKo: '웨다나-수', meaning: '느낌들에서', grammar: '여성 복수 처격' },
  ...
  { pali: 'vā', pronKo: '와-', meaning: '또는', grammar: '불변어' },
  { pali: 'panassa', pronKo: '빠낫사', meaning: '그에게(pana+assa)', grammar: '접속사+대명사 간접목적격' },
  ...
  { pali: 'ñāṇamattāya', pronKo: '냐-나맛따-야', meaning: '앎만을 위해', grammar: '중성 단수 간접목적격 (ñāṇa + matta)' },
...
export const VERSE_3_WORDS: VerseWord[] = [
  ...
  { pali: 'vā', pronKo: '와-', meaning: '또는', grammar: '불변어' },
  { pali: 'citte', pronKo: '짓떼', meaning: '마음에서', grammar: '중성 단수 처격' },
  ...
  { pali: 'vā', pronKo: '와-', meaning: '또는', grammar: '불변어' },
  { pali: 'panassa', pronKo: '빠낫사', meaning: '그에게', grammar: '접속사+대명사 간접목적격' },
...
export const VERSE_4_WORDS: VerseWord[] = [
  ...
  { pali: 'viharati', pronKo: '위하라띠', meaning: '머문다', grammar: '현재 3인칭 단수' },
  { pali: 'pañcasu', pronKo: '빤짜수', meaning: '다섯의', grammar: '수사 복수 처격' },
  { pali: 'nīvaraṇesu', pronKo: '니-와라네수', meaning: '장애들에서', grammar: '중성 복수 처격' },
]
...
export const VERSE_5_WORDS: VerseWord[] = [
  ...
  { pali: 'atthi', pronKo: '앗티', meaning: '있다', grammar: '현재 3인칭 단수' },
  { pali: 'me', pronKo: '메', meaning: '나의/내 안에', grammar: '대명사 1인칭 소유격/간접목적격' },
...
export const VERSE_6_WORDS: VerseWord[] = [
  ...
  { pali: 'viharati', pronKo: '위하라띠', meaning: '머문다', grammar: '현재 3인칭 단수' },
  { pali: 'pañcasu', pronKo: '빤짜수', meaning: '다섯의', grammar: '수사 복수 처격' },
  { pali: 'upādānakkhandhesu', pronKo: '우빠-다-낙칸데수', meaning: '취착의 무더기들에서', grammar: '남성 복수 처격' },
  // 5온 관찰
  { pali: 'Idha', pronKo: '이다', meaning: '여기서', grammar: '불변어(부사)' },
  { pali: 'bhikkhave', pronKo: '빅카웨', meaning: '비구들이여', grammar: '남성 복수 부름격' },
  { pali: 'bhikkhu', pronKo: '빅쿠', meaning: '비구는', grammar: '남성 단수 주격' },
...
export const VERSE_7 = {
  ...
  grammarNotes: [
    ...
    '핵심 문법: ajjhattikabāhiresu = ajjhattika(내적) + bāhira(외적) + 처격 복수. saṃyojanaṃ = 족쇄/결박(중성 단수 목적격)',
...
export const VERSE_7_WORDS: VerseWord[] = [
  ...
  { pali: 'viharati', pronKo: '위하라띠', meaning: '머문다', grammar: '현재 3인칭 단수' },
  { pali: 'chasu', pronKo: '차수', meaning: '여섯의', grammar: '수사 복수 처격' },
  { pali: 'ajjhattikabāhiresu', pronKo: '앗잣띠까바-히레수', meaning: '안팎의', grammar: '형용사 복수 처격' },
  { pali: 'āyatanesu', pronKo: '아-야따네수', meaning: '감각장소들에서', grammar: '중성 복수 처격' },
  // 눈-형상
  { pali: 'Idha', pronKo: '이다', meaning: '여기서', grammar: '불변어(부사)' },
  { pali: 'bhikkhave', pronKo: '빅카웨', meaning: '비구들이여', grammar: '남성 복수 부름격' },
  { pali: 'bhikkhu', pronKo: '빅쿠', meaning: '비구는', grammar: '남성 단수 주격' },
...
export const VERSE_8_WORDS: VerseWord[] = [
  ...
  { pali: 'viharati', pronKo: '위하라띠', meaning: '머문다', grammar: '현재 3인칭 단수' },
  { pali: 'sattasu', pronKo: '삿따수', meaning: '일곱의', grammar: '수사 복수 처격' },
  { pali: 'bojjhaṅgesu', pronKo: '봇장게수', meaning: '깨달음의 요소들에서', grammar: '중성 복수 처격' },
  // 새김의 깨달음 요소 — 있음
  { pali: 'Idha', pronKo: '이다', meaning: '여기서', grammar: '불변어(부사)' },
  { pali: 'bhikkhave', pronKo: '빅카웨', meaning: '비구들이여', grammar: '남성 복수 부름격' },
  { pali: 'bhikkhu', pronKo: '빅쿠', meaning: '비구는', grammar: '남성 단수 주격' },
...
export const VERSE_9_WORDS: VerseWord[] = [
  ...
  { pali: 'dhammānupassī', pronKo: '담마-누빳시-', meaning: '법을 관찰하는', grammar: '형용사' },
  { pali: 'viharati', pronKo: '위하라띠', meaning: '머문다', grammar: '현재 3인칭 단수' },
  { pali: 'catūsu', pronKo: '짜뚜-수', meaning: '네 가지의', grammar: '수사 복수 처격' },
  { pali: 'ariyasaccesu', pronKo: '아리야삿쩨수', meaning: '거룩한 진리들에서', grammar: '중성 복수 처격' },
]
...
export const VERSE_14 = {
  ...
  grammarNotes: [
    ...
    '핵심 문법: dukkhe/dukkhasamudaye/dukkhanirodhe = 처격("~에 대한"). dukkhanirodhagāminiyā paṭipadāya = 여성 단수 처격(소유격)',
...
export const VERSE_16 = {
  ...
  grammarNotes: [
    ...
    '핵심 문법: veramaṇī = 삼감/자제(여성 단수 주격). 분리격(-ā)은 "~로부터의" 의미로 삼감의 대상을 나타냄',
  ],
}
...
export const VERSE_16_WORDS: VerseWord[] = [
  ...
  { pali: 'Musāvādā', pronKo: '무사-와-다-', meaning: '거짓말로부터', grammar: '남성 단수 분리격 (musā + vāda)', important: true },
  { pali: 'veramaṇī', pronKo: '웨라마니-', meaning: '삼감/자제', grammar: '여성 단수 주격', important: true },
  { pali: 'pisuṇāya', pronKo: '삐수나-야', meaning: '이간질하는', grammar: '형용사 여성 단수 분리격' },
  { pali: 'vācāya', pronKo: '와-짜-야', meaning: '말로부터', grammar: '여성 단수 분리격' },
  { pali: 'veramaṇī', pronKo: '웨라마니-', meaning: '삼감', grammar: '여성 단수 주격' },
  { pali: 'pharusāya', pronKo: '파루사-야', meaning: '거친/난폭한', grammar: '형용사 여성 단수 분리격', important: true },
  { pali: 'vācāya', pronKo: '와-짜-야', meaning: '말로부터', grammar: '여성 단수 분리격' },
  { pali: 'veramaṇī', pronKo: '웨라마니-', meaning: '삼감', grammar: '여성 단수 주격' },
  { pali: 'samphappalāpā', pronKo: '삼팝빠라-빠-', meaning: '쓸데없는 말로부터', grammar: '남성 단수 분리격', important: true },
  { pali: 'veramaṇī', pronKo: '웨라마니-', meaning: '삼감', grammar: '여성 단수 주격' },
  { pali: 'ayaṃ', pronKo: '아양', meaning: '이것을', grammar: '지시대명사' },
  { pali: 'vuccati', pronKo: '웃짜띠', meaning: '~라고 불린다', grammar: '수동태 현재 3인칭 단수' },
  { pali: 'bhikkhave', pronKo: '빅카웨', meaning: '비구들이여', grammar: '남성 복수 부름격' },
...
export const VERSE_17_WORDS: VerseWord[] = [
  ...
  { pali: 'Pāṇātipātā', pronKo: '빠-나-띠빠-따-', meaning: '살생으로부터', grammar: '남성 단수 분리격 (pāṇa + atipāta)', important: true },
  { pali: 'veramaṇī', pronKo: '웨라마니-', meaning: '삼감/자제', grammar: '여성 단수 주격' },
  { pali: 'adinnādānā', pronKo: '아딘나-다-나-', meaning: '도둑질로부터', grammar: '중성 단수 분리격 (adinna + ādāna)', important: true },
  { pali: 'veramaṇī', pronKo: '웨라마니-', meaning: '삼감', grammar: '여성 단수 주격' },
  { pali: 'kāmesumicchācārā', pronKo: '까-메수밋차-짜-라-', meaning: '사음으로부터', grammar: '남성 단수 분리격 (kāmesu + micchā + cāra)', important: true },
  { pali: 'veramaṇī', pronKo: '웨라마니-', meaning: '삼감', grammar: '여성 단수 주격' },
  { pali: 'ayaṃ', pronKo: '아양', meaning: '이것을', grammar: '지시대명사' },
  { pali: 'vuccati', pronKo: '웃짜띠', meaning: '~라고 불린다', grammar: '수동태 현재 3인칭 단수' },
  { pali: 'bhikkhave', pronKo: '빅카웨', meaning: '비구들이여', grammar: '남성 복수 부름격' },
...
export const VERSE_19 = {
  ...
  grammarNotes: [
    ...
    '간접목적격 목적: anuppādāya(안 생겨나게), pahānāya(버리기 위해), uppādāya(생겨나게), ṭhitiyā/asammosāya/bhiyyobhāvāya/vepullāya/bhāvanāya/pāripūriyā(지속/유지/증장/완성 위해)',
  ],
}
...
export const VERSE_19_WORDS: VerseWord[] = [
  ...
  { pali: 'anuppādāya', pronKo: '아눕빠-다-야', meaning: '안 생겨나게 하기 위해', grammar: '남성 단수 간접목적격 (an + uppāda)' },
  ...
  { pali: 'dhammānaṃ', pronKo: '담마-낭', meaning: '법들의', grammar: '남성 복수 소유격' },
  { pali: 'pahānāya', pronKo: '빠하-나-야', meaning: '버리기 위해', grammar: '중성 단수 간접목적격' },
  ...
  { pali: 'dhammānaṃ', pronKo: '담마-낭', meaning: '법들의', grammar: '남성 복수 소유격' },
  { pali: 'uppādāya', pronKo: '웁빠-다-야', meaning: '생겨나게 하기 위해', grammar: '남성 단수 간접목적격' },
  { pali: 'chandaṃ', pronKo: '찬당', meaning: '의욕을', grammar: '남성 단수 목적격' },
  { pali: 'janeti', pronKo: '자네띠', meaning: '낸다', grammar: '현재 3인칭 단수' },
  { pali: 'vāyamati', pronKo: '와-야마띠', meaning: '노력한다', grammar: '현재 3인칭 단수' },
  { pali: 'vīriyaṃ', pronKo: '위-리양', meaning: '정진을', grammar: '중성 단수 목적격' },
  ...
  { pali: 'dhammānaṃ', pronKo: '담마-낭', meaning: '법들의', grammar: '남성 복수 소유격' },
  { pali: 'ṭhitiyā', pronKo: '티띠야-', meaning: '지속을 위해', grammar: '여성 단수 간접목적격' },
  { pali: 'asammosāya', pronKo: '아삼모사-야', meaning: '사라지지 않게 하기 위해', grammar: '남성 단수 간접목적격 (a + sammosa)' },
  { pali: 'bhiyyobhāvāya', pronKo: '빗요바-와-야', meaning: '더 늘어나기 위해', grammar: '남성 단수 간접목적격 (bhiyyo + bhāva)' },
  { pali: 'vepullāya', pronKo: '웨뿔라-야', meaning: '넓어지기 위해', grammar: '중성 단수 간접목적격' },
  { pali: 'bhāvanāya', pronKo: '바-와나-야', meaning: '수행으로', grammar: '여성 단수 간접목적격' },
  { pali: 'pāripūriyā', pronKo: '빠-리뿌-리야-', meaning: '완성을 위해', grammar: '여성 단수 간접목적격' },
  { pali: 'chandaṃ', pronKo: '찬당', meaning: '의욕을', grammar: '남성 단수 목적격' },
  { pali: 'janeti', pronKo: '자네띠', meaning: '낸다', grammar: '현재 3인칭 단수' },
  { pali: 'vāyamati', pronKo: '와-야마띠', meaning: '노력한다', grammar: '현재 3인칭 단수' },
  { pali: 'vīriyaṃ', pronKo: '위-리양', meaning: '정진을', grammar: '중성 단수 목적격' },
...
export const VERSE_21_WORDS: VerseWord[] = [
  ...
  { pali: 'kāmehi', pronKo: '까-메히', meaning: '감각적 쾌락들로부터', grammar: '남성 복수 분리격' },
  { pali: 'vivicca', pronKo: '위윗짜', meaning: '떠나서', grammar: '절대분사' },
  { pali: 'akusalehi', pronKo: '아꾸살레히', meaning: '불선한 것들로부터', grammar: '형용사 남성 복수 분리격' },
  { pali: 'dhammehi', pronKo: '담메히', meaning: '법들로부터', grammar: '남성 복수 분리격' },
  ...
  { pali: 'vūpasamā', pronKo: '우-빠사마-', meaning: '가라앉음으로', grammar: '남성 단수 분리격', important: true },
  { pali: 'ajjhattaṃ', pronKo: '앗잣땅', meaning: '안으로', grammar: '부사' },
  ...
  { pali: 'viharati', pronKo: '위하라띠', meaning: '머문다', grammar: '현재 3인칭 단수' },
  // 3선정
  { pali: 'Pītiyā', pronKo: '삐-띠야-', meaning: '기쁨의', grammar: '여성 단수 분리격/소유격' },
  { pali: 'ca', pronKo: '짜', meaning: '그리고', grammar: '불변어' },
  { pali: 'virāgā', pronKo: '위라-가-', meaning: '탐욕 떠남으로', grammar: '남성 단수 분리격', important: true },
  ...
  { pali: 'ca', pronKo: '짜', meaning: '그리고', grammar: '불변어' },
  { pali: 'pahānā', pronKo: '빠하-나-', meaning: '버림으로', grammar: '중성 단수 분리격' },
  ...
  { pali: 'atthaṅgamā', pronKo: '앗탕가마-', meaning: '사라짐으로', grammar: '남성 단수 분리격' },
...
export const VERSE_22_WORDS: VerseWord[] = [
  ...
  { pali: 'tassa', pronKo: '땃사', meaning: '그에게', grammar: '대명사 남성 단수 소유격/간접목적격' },
  ...
  { pali: 'sati', pronKo: '사띠', meaning: '있을 때', grammar: '현재분사 처격' },
  { pali: 'vā', pronKo: '와-', meaning: '또는', grammar: '불변어' },
  ...
  { pali: 'tassa', pronKo: '땃사', meaning: '그에게', grammar: '대명사 소유격/간접목적격' },
  { pali: 'dvinnaṃ', pronKo: '드윈낭', meaning: '둘의', grammar: '수사 소유격' },
  ...
  { pali: 'diṭṭheva', pronKo: '딧테와', meaning: '바로 현생에서', grammar: '과거분사 처격+강조사' },
  { pali: 'dhamme', pronKo: '담메', meaning: '법에서', grammar: '남성 단수 처격' },
  { pali: 'aññā', pronKo: '안냐-', meaning: '완전한 앎', grammar: '여성 단수 주격' },
  { pali: 'sati', pronKo: '사띠', meaning: '있을 때', grammar: '현재분사 처격' },
  { pali: 'vā', pronKo: '와-', meaning: '또는', grammar: '불변어' },
  { pali: 'upādisese', pronKo: '우빠-디세세', meaning: '취착의 남은 것이 있을 때', grammar: '남성 단수 처격' },
...
export const VERSE_23_WORDS: VerseWord[] = [
  ...
  { pali: 'visuddhiyā', pronKo: '위숫디야-', meaning: '청정을 위해', grammar: '여성 단수 간접목적격', important: true },
  { pali: 'sokaparidevānaṃ', pronKo: '소까빠리데와-낭', meaning: '슬픔과 비탄의', grammar: '남성 복수 소유격 (soka + parideva)' },
  { pali: 'samatikkamāya', pronKo: '사마띡까마-야', meaning: '극복하기 위해', grammar: '남성 단수 간접목적격' },
  { pali: 'dukkhadomanassānaṃ', pronKo: '둑카도마낫사-낭', meaning: '괴로움과 근심의', grammar: '중성 복수 소유격 (dukkha + domanassa)' },
  { pali: 'atthaṅgamāya', pronKo: '앗탕가마-야', meaning: '소멸하기 위해', grammar: '남성 단수 간접목적격' },
  { pali: 'ñāyassa', pronKo: '냐-얏사', meaning: '바른 방법의', grammar: '남성 단수 소유격' },
  { pali: 'adhigamāya', pronKo: '아디가마-야', meaning: '얻기 위해', grammar: '남성 단수 간접목적격', important: true },
  { pali: 'nibbānassa', pronKo: '닙바-낫사', meaning: '열반의', grammar: '중성 단수 소유격', important: true },
  { pali: 'sacchikiriyāya', pronKo: '삿치끼리야-야', meaning: '실현하기 위해', grammar: '여성 단수 간접목적격 (sacchi + kiriyā)', important: true },
