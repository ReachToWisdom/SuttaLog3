...
export const VERSE_2_WORDS: VerseWord[] = [
  ...
  { pali: 'sukhaṃ', pronKo: '수캉', meaning: '즐거운', grammar: '형용사 중성/여성 단수 대격' },
  { pali: 'vedanaṃ', pronKo: '웨다낭', meaning: '느낌을', grammar: '여성 단수 대격' },
  ...
  { pali: 'kiñci', pronKo: '긴찌', meaning: '어떤 것도', grammar: '부정대명사 중성 단수 대격' },
...
export const VERSE_3_WORDS: VerseWord[] = [
  ...
  { pali: 'vā', pronKo: '와-', meaning: '또는', grammar: '불변어' },
  { pali: 'cittaṃ', pronKo: '짓땅', meaning: '마음을', grammar: '중성 단수 대격' },
...
export const VERSE_5_WORDS: VerseWord[] = [
  ...
  { pali: 'vā', pronKo: '와-', meaning: '또는', grammar: '불변어' },
  { pali: 'ajjhattaṃ', pronKo: '앗잣땅', meaning: '안에', grammar: '부사' },
  { pali: 'kāmacchandaṃ', pronKo: '까-맛찬당', meaning: '감각적 욕망을', grammar: '남성 단수 대격' },
  ...
  { pali: 'ca', pronKo: '짜', meaning: '그리고', grammar: '불변어' },
  { pali: 'anuppannassa', pronKo: '아눕빤낫사', meaning: '아직 생겨나지 않은 것의', grammar: '과거분사 남성 단수 속격', important: true },
  { pali: 'kāmacchandassa', pronKo: '까-맛찬닷사', meaning: '감각적 욕망의', grammar: '남성 단수 속격' },
  { pali: 'uppādo', pronKo: '웁빠-도', meaning: '생겨남/일어남', grammar: '남성 단수 주격', important: true },
  { pali: 'hoti', pronKo: '호띠', meaning: '~이다/된다', grammar: '현재 3인칭 단수' },
  { pali: 'tañca', pronKo: '딴짜', meaning: '그것을 그리고', grammar: '대명사 대격 + ca' },
  { pali: 'pajānāti', pronKo: '빠자-나-띠', meaning: '알아차린다', grammar: '현재 3인칭 단수' },
  // 감각적 욕망 — 버림
...
export const VERSE_7_WORDS: VerseWord[] = [
  ...
  { pali: 'pajānāti', pronKo: '빠자-나-띠', meaning: '알아차린다', grammar: '현재 3인칭 단수' },
  // 족쇄 관찰
  { pali: 'yañca', pronKo: '얀짜', meaning: '그리고 그것을', grammar: '관계대명사 중성 대격 + ca' },
  ...
  { pali: 'yathā', pronKo: '야타-', meaning: '~하는 방식으로', grammar: '불변어' },
  { pali: 'ca', pronKo: '짜', meaning: '그리고', grammar: '불변어' },
  { pali: 'anuppannassa', pronKo: '아눕빤낫사', meaning: '아직 생겨나지 않은 것의', grammar: '과거분사 속격' },
  { pali: 'saṃyojanassa', pronKo: '상요자낫사', meaning: '족쇄의', grammar: '중성 단수 속격' },
  ...
  { pali: 'yathā', pronKo: '야타-', meaning: '~하는 방식으로', grammar: '불변어' },
  { pali: 'ca', pronKo: '짜', meaning: '그리고', grammar: '불변어' },
  { pali: 'uppannassa', pronKo: '웁빤낫사', meaning: '생겨난 것의', grammar: '과거분사 속격' },
  { pali: 'saṃyojanassa', pronKo: '상요자낫사', meaning: '족쇄의', grammar: '중성 단수 속격' },
  ...
  { pali: 'yathā', pronKo: '야타-', meaning: '~하는 방식으로', grammar: '불변어' },
  { pali: 'ca', pronKo: '짜', meaning: '그리고', grammar: '불변어' },
  { pali: 'pahīnassa', pronKo: '빠히-낫사', meaning: '버려진 것의', grammar: '과거분사 속격' },
  { pali: 'saṃyojanassa', pronKo: '상요자낫사', meaning: '족쇄의', grammar: '중성 단수 속격' },
  ...
  { pali: 'saṃyojanaṃ', pronKo: '상요자낭', meaning: '족쇄를', grammar: '중성 단수 대격' },
  { pali: 'tañca', pronKo: '딴짜', meaning: '그것을 그리고', grammar: '대명사 대격 + ca' },
  { pali: 'pajānāti', pronKo: '빠자-나-띠', meaning: '알아차린다', grammar: '현재 3인칭 단수' },
  // 정형문: 안/밖/안팎 + 생멸 + 새김 확립
  { pali: 'Iti', pronKo: '이띠', meaning: '이와 같이', grammar: '불변어' },
...
export const VERSE_8_WORDS: VerseWord[] = [
  ...
  { pali: 'vā', pronKo: '와-', meaning: '또는', grammar: '불변어' },
  { pali: 'ajjhattaṃ', pronKo: '앗잣땅', meaning: '안에', grammar: '부사' },
  { pali: 'satisambojjhaṅgaṃ', pronKo: '사띠삼봇장강', meaning: '새김의 깨달음 요소를', grammar: '남성 단수 대격', important: true },
  { pali: 'atthi', pronKo: '앗티', meaning: '있다', grammar: '현재 3인칭 단수' },
  { pali: 'me', pronKo: '메', meaning: '나의', grammar: '대명사 1인칭' },
  { pali: 'ajjhattaṃ', pronKo: '앗잣땅', meaning: '안에', grammar: '부사' },
  ...
  { pali: 'vā', pronKo: '와-', meaning: '또는', grammar: '불변어' },
  { pali: 'ajjhattaṃ', pronKo: '앗잣땅', meaning: '안에', grammar: '부사' },
  { pali: 'satisambojjhaṅgaṃ', pronKo: '사띠삼봇장강', meaning: '새김의 깨달음 요소를', grammar: '남성 단수 대격' },
  ...
  { pali: 'ca', pronKo: '짜', meaning: '그리고', grammar: '불변어' },
  { pali: 'anuppannassa', pronKo: '아눕빤낫사', meaning: '아직 생겨나지 않은 것의', grammar: '과거분사 속격' },
  { pali: 'satisambojjhaṅgassa', pronKo: '사띠삼봇장갓사', meaning: '새김의 깨달음 요소의', grammar: '남성 단수 속격' },
  { pali: 'uppādo', pronKo: '웁빠-도', meaning: '생겨남', grammar: '남성 단수 주격' },
  { pali: 'hoti', pronKo: '호띠', meaning: '~이다', grammar: '현재 3인칭 단수' },
  { pali: 'tañca', pronKo: '딴짜', meaning: '그것을 그리고', grammar: '대명사 대격 + ca' },
  { pali: 'pajānāti', pronKo: '빠자-나-띠', meaning: '알아차린다', grammar: '현재 3인칭 단수' },
...
export const VERSE_19_WORDS: VerseWord[] = [
  ...
  { pali: 'pāpakānaṃ', pronKo: '빠-빠까-낭', meaning: '나쁜 것들의', grammar: '형용사 복수 속격' },
  { pali: 'akusalānaṃ', pronKo: '아꾸살라-낭', meaning: '불선한 것들의', grammar: '형용사 복수 속격' },
  { pali: 'dhammānaṃ', pronKo: '담마-낭', meaning: '법들의', grammar: '남성 복수 속격' },
  { pali: 'pahānāya', pronKo: '빠하-나-야', meaning: '버리기 위해', grammar: '중성 단수 여격' },
  { pali: 'chandaṃ', pronKo: '찬당', meaning: '의욕을', grammar: '남성 단수 대격' },
  { pali: 'janeti', pronKo: '자네띠', meaning: '낸다', grammar: '현재 3인칭 단수' },
  { pali: 'vāyamati', pronKo: '와-야마띠', meaning: '노력한다', grammar: '현재 3인칭 단수' },
  { pali: 'vīriyaṃ', pronKo: '위-리양', meaning: '정진을', grammar: '중성 단수 대격' },
  { pali: 'ārabhati', pronKo: '아-라바띠', meaning: '시작하다', grammar: '현재 3인칭 단수' },
  { pali: 'cittaṃ', pronKo: '짓땅', meaning: '마음을', grammar: '중성 단수 대격' },
  { pali: 'paggaṇhāti', pronKo: '빡가나-띠', meaning: '굳건히 한다', grammar: '현재 3인칭 단수' },
  { pali: 'padahati', pronKo: '빠다하띠', meaning: '분투한다', grammar: '현재 3인칭 단수' },
  // 3정근: 선법 생성
  { pali: 'anuppannānaṃ', pronKo: '아눕빤나-낭', meaning: '아직 생겨나지 않은 것들의', grammar: '과거분사 복수 속격' },
  ...
  { pali: 'padahati', pronKo: '빠다하띠', meaning: '분투한다', grammar: '현재 3인칭 단수' },
  // 4정근: 선법 증장
  { pali: 'uppannānaṃ', pronKo: '웁빤나-낭', meaning: '이미 생겨난 것들의', grammar: '과거분사 복수 속격' },
  { pali: 'kusalānaṃ', pronKo: '꾸살라-낭', meaning: '선한 것들의', grammar: '형용사 복수 속격' },
  { pali: 'dhammānaṃ', pronKo: '담마-낭', meaning: '법들의', grammar: '남성 복수 속격' },
...
export const VERSE_20_WORDS: VerseWord[] = [
  ...
  { pali: 'loke', pronKo: '로게', meaning: '세상에서', grammar: '남성 단수 처격' },
  { pali: 'abhijjhādomanassaṃ', pronKo: '아비짜-도마낫상', meaning: '탐욕과 근심을', grammar: '중성 단수 대격' },
  // 심념처
  { pali: 'citte', pronKo: '짓떼', meaning: '마음에서', grammar: '중성 단수 처격' },
  { pali: 'cittānupassī', pronKo: '짓따-누빳시-', meaning: '마음을 관찰하는', grammar: '형용사' },
  { pali: 'viharati', pronKo: '위하라띠', meaning: '머문다', grammar: '현재 3인칭 단수' },
...
export const VERSE_21_WORDS: VerseWord[] = [
  ...
  { pali: 'pītisukhaṃ', pronKo: '삐-띠수캉', meaning: '기쁨과 즐거움', grammar: '중성 단수 대격' },
  { pali: 'dutiyaṃ', pronKo: '두띠양', meaning: '둘째', grammar: '서수 중성 단수 대격' },
  { pali: 'jhānaṃ', pronKo: '자-낭', meaning: '선정을', grammar: '중성 단수 대격' },
...
export const VERSE_22_WORDS: VerseWord[] = [
  ...
  { pali: 'bhikkhave', pronKo: '빅카웨', meaning: '비구들이여', grammar: '남성 복수 호격' },
  { pali: 'sattavassāni', pronKo: '삿따왓사-니', meaning: '7년간', grammar: '중성 복수 대격' },
  { pali: 'chabbassāni', pronKo: '찹밧사-니', meaning: '6년간', grammar: '중성 복수 대격 (cha + vassa)' },
  { pali: 'pañcavassāni', pronKo: '빤짜왓사-니', meaning: '5년간', grammar: '중성 복수 대격' },
  { pali: 'cattāri', pronKo: '짯따-리', meaning: '넷', grammar: '수사 중성 복수' },
  { pali: 'vassāni', pronKo: '왓사-니', meaning: '년간', grammar: '중성 복수 대격' },
  { pali: 'tīṇi', pronKo: '띠-니', meaning: '셋', grammar: '수사 중성 복수' },
  { pali: 'vassāni', pronKo: '왓사-니', meaning: '년간', grammar: '중성 복수 대격' },
  { pali: 'dve', pronKo: '드웨', meaning: '둘', grammar: '수사' },
  { pali: 'vassāni', pronKo: '왓사-니', meaning: '년간', grammar: '중성 복수 대격' },
  { pali: 'ekaṃ', pronKo: '에깡', meaning: '하나', grammar: '수사 중성 단수 대격' },
  { pali: 'vassaṃ', pronKo: '왓상', meaning: '년', grammar: '중성 단수 대격' },
  { pali: 'sattamāse', pronKo: '삿따마-세', meaning: '7개월간', grammar: '남성 복수 대격' },
  { pali: 'chamāse', pronKo: '차마-세', meaning: '6개월간', grammar: '남성 복수 대격' },
  { pali: 'pañcamāse', pronKo: '빤짜마-세', meaning: '5개월간', grammar: '남성 복수 대격' },
  { pali: 'cattāro', pronKo: '짯따-로', meaning: '넷', grammar: '수사 남성 복수' },
  { pali: 'māse', pronKo: '마-세', meaning: '개월간', grammar: '남성 복수 대격' },
  { pali: 'tīṇi', pronKo: '띠-니', meaning: '셋', grammar: '수사' },
  { pali: 'māse', pronKo: '마-세', meaning: '개월간', grammar: '남성 복수 대격' },
  { pali: 'dve', pronKo: '드웨', meaning: '둘', grammar: '수사' },
  { pali: 'māse', pronKo: '마-세', meaning: '개월간', grammar: '남성 복수 대격' },
  { pali: 'ekaṃ', pronKo: '에깡', meaning: '하나', grammar: '수사' },
  { pali: 'māsaṃ', pronKo: '마-상', meaning: '개월', grammar: '남성 단수 대격' },
  { pali: 'aḍḍhamāsaṃ', pronKo: '앋다마-상', meaning: '보름/반달', grammar: '남성 단수 대격 (aḍḍha + māsa)' },
  // 마지막 문장: 7일
  ...
  { pali: 'satipaṭṭhāne', pronKo: '사띠빳타-네', meaning: '새김의 확립을', grammar: '남성 복수 대격' },
  ...
  { pali: 'tassa', pronKo: '땃사', meaning: '그에게', grammar: '대명사 속격/여격' },
  { pali: 'dvinnaṃ', pronKo: '드윈낭', meaning: '둘의', grammar: '수사 속격' },
  { pali: 'phalānaṃ', pronKo: '팔라-낭', meaning: '과보들의', grammar: '중성 복수 속격' },
