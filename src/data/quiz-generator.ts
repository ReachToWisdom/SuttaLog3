...
const CASE_DISTRACTORS: Record<string, { text: string; why: string }[]> = {
  ...
  'dhammesu': [
    { text: 'dhammaṃ', why: 'dhammaṃ은 단수 목적격(법을), dhammesu는 복수 처소격(법들에서)입니다' },
    { text: 'dhammā', why: 'dhammā는 복수 주격(법들이)입니다' },
    { text: 'dhammassa', why: 'dhammassa는 단수 소유격(법의)입니다' },
  ],
  'cittaṃ': [
    { text: 'cittassa', why: 'cittassa는 소유격(마음의)입니다' },
    { text: 'cittena', why: 'cittena는 구격(마음에 의해)입니다' },
    { text: 'cittesu', why: 'cittesu는 복수 처소격(마음들에서)입니다' },
  ],
  'kammāni': [
  ...
  'dhammaṃ': [
    ...
    { text: 'dhamme', why: 'dhamme는 처소격(법에서)입니다' },
    { text: 'dhammena', why: 'dhammena는 구격(법에 의해)입니다' },
  ],
  // tathāgata 격변화
  'tathāgatena': [
  ...
  'dukkhaṃ': [
    ...
    { text: 'dukkhe', why: 'dukkhe는 처소격(고통에서)입니다' },
  ],
  // magga (도)
  'maggo': [
  ...
  'rūpaṃ': [
    ...
    { text: 'rūpe', why: 'rūpe는 처소격(물질에서)입니다' },
  ],
  'vedanā': [
    { text: 'vedanāya', why: 'vedanāya는 여격/처소격(느낌에/느낌에서)입니다' },
    { text: 'vedanaṃ', why: 'vedanaṃ은 목적격(느낌을)입니다' },
    { text: 'vedanāsu', why: 'vedanāsu는 복수 처소격(느낌들에서)입니다' },
  ],
  'saññā': [
    { text: 'saññāya', why: 'saññāya는 여격/처소격(인식에서)입니다' },
    { text: 'saññaṃ', why: 'saññaṃ은 목적격(인식을)입니다' },
    { text: 'saññāsu', why: 'saññāsu는 복수 처소격(인식들에서)입니다' },
  ],
  'saṅkhārā': [
    { text: 'saṅkhāre', why: 'saṅkhāre는 목적격 복수(형성들을)입니다' },
    { text: 'saṅkhāresu', why: 'saṅkhāresu는 처소격 복수(형성들에서)입니다' },
  ...
  'viññāṇaṃ': [
    ...
    { text: 'viññāṇe', why: 'viññāṇe는 처소격(의식에서)입니다' },
  ],
  'anattā': [
    { text: 'attā', why: 'attā는 "자아"이고, anattā는 "무아(자아가 아닌)"입니다 — 정반대!' },
    { text: 'anattaṃ', why: 'anattaṃ은 목적격(무아를)이지 주격이 아닙니다' },
  ...
  // ── 사념처경 핵심 단어 ──
  'kāye': [
    { text: 'kāyo', why: 'kāyo는 주격(몸이)이지 처소격(몸에서)이 아닙니다' },
    { text: 'kāyaṃ', why: 'kāyaṃ은 목적격(몸을)입니다' },
    { text: 'kāyassa', why: 'kāyassa는 소유격(몸의)입니다' },
  ],
  'satiṃ': [
  ...
  'taṇhā': [
    ...
    { text: 'taṇhāsu', why: 'taṇhāsu는 복수 처소격(갈애들에서)입니다' },
  ],
}
