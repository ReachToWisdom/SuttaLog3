...
export const VERSE_3 = {
  ...
  grammarNotes: [
    ...
    '핵심 문법: tathāgatena(조격)는 비교 대상 — "여래와 비교하여 같은 것이 없다". kiñci는 부정대명사(kiṃ+ci)',
...
export const VERSE_3_WORDS: VerseWord[] = [
  ...
  { pali: 'tathāgatena', pronKo: '따타-가떼나', meaning: '여래에 의해/여래와', grammar: '남성 단수 조격' },
  ...
  { pali: 'etena', pronKo: '에떼나', meaning: '이것에 의해', grammar: '지시대명사 중성 단수 조격' },
  { pali: 'saccena', pronKo: '삿쩨나', meaning: '진실에 의해', grammar: '중성 단수 조격' },
...
export const VERSE_4_WORDS: VerseWord[] = [
  ...
  { pali: 'tena', pronKo: '떼나', meaning: '그것에 의해/그와', grammar: '지시대명사 남성 단수 조격' },
  { pali: 'dhammena', pronKo: '담메나', meaning: '법에 의해/법과', grammar: '남성 단수 조격' },
...
export const VERSE_5_WORDS: VerseWord[] = [
  ...
  { pali: 'samādhinā', pronKo: '사마-디나-', meaning: '삼매에 의해/삼매와', grammar: '남성 단수 조격' },
...
export const VERSE_7 = {
  ...
  grammarNotes: [
    ...
    '핵심 문법: bhuñjamānā(현재분사)는 진행 중인 향유. manasā daḷhena(조격)는 수단 — "굳건한 마음으로"',
...
export const VERSE_7_WORDS: VerseWord[] = [
  ...
  { pali: 'manasā', pronKo: '마나사-', meaning: '마음으로', grammar: '중성 단수 조격' },
  { pali: 'daḷhena', pronKo: '달헤나', meaning: '굳건한', grammar: '형용사 중성 단수 조격' },
...
export const VERSE_8_WORDS: VerseWord[] = [
  ...
  { pali: 'catubbhi', pronKo: '짜뚭비', meaning: '네 가지의', grammar: '수사 조격 복수 (catu)' },
  { pali: 'vātehi', pronKo: '와-떼히', meaning: '바람들에 의해', grammar: '남성 복수 조격' },
...
export const VERSE_9_WORDS: VerseWord[] = [
  ...
  { pali: 'gambhīrapaññena', pronKo: '감비-라빤녜나', meaning: '깊은 지혜를 가진 분에 의해', grammar: '남성 단수 조격 (gambhīra + pañña)' },
...
export const VERSE_10_WORDS: VerseWord[] = [
  ...
  { pali: 'dassanasampadāya', pronKo: '닷사나삼빠다-야', meaning: '견해의 성취에 의해', grammar: '여성 단수 조격 (dassana + sampadā)' },
...
export const VERSE_12_WORDS: VerseWord[] = [
  ...
  { pali: 'vācā', pronKo: '와-짜-', meaning: '말로', grammar: '여성 단수 조격' },
  { pali: 'uda', pronKo: '우다', meaning: '또는', grammar: '불변어(접속사)' },
  { pali: 'cetasā', pronKo: '쩨따사-', meaning: '마음으로', grammar: '중성 단수 조격 (cetas)' },
  { pali: 'abhabbo', pronKo: '아밥보', meaning: '불가능한/~할 수 없는', grammar: '형용사 남성 단수 주격' },
