...
export const VERSE_13 = {
  ...
  grammarNotes: [
    ...
    '핵심 문법: khajjamānaṃ = 현재수동분사("먹히고 있는", khādati). 조격(-ehi)이 행위자("~에 의해") 표시',
...
export const VERSE_13_WORDS: VerseWord[] = [
  ...
  // 동물 8종 + 벌레
  { pali: 'kākehi', pronKo: '까-게히', meaning: '까마귀에 의해', grammar: '남성 복수 조격 (kāka)', important: true },
  { pali: 'vā', pronKo: '와-', meaning: '또는', grammar: '불변어(접속사)' },
  { pali: 'khajjamānaṃ', pronKo: '캇자마-낭', meaning: '먹히고 있는', grammar: '현재수동분사 중성 단수 목적격 (khādati)', important: true },
  { pali: 'kulalehi', pronKo: '꿀라레히', meaning: '매에 의해', grammar: '남성 복수 조격 (kulala)' },
  { pali: 'vā', pronKo: '와-', meaning: '또는', grammar: '불변어(접속사)' },
  { pali: 'khajjamānaṃ', pronKo: '캇자마-낭', meaning: '먹히고 있는', grammar: '현재수동분사 중성 단수 목적격' },
  { pali: 'gijjhehi', pronKo: '긷제히', meaning: '독수리에 의해', grammar: '남성 복수 조격 (gijjha)' },
  { pali: 'vā', pronKo: '와-', meaning: '또는', grammar: '불변어(접속사)' },
  { pali: 'khajjamānaṃ', pronKo: '캇자마-낭', meaning: '먹히고 있는', grammar: '현재수동분사 중성 단수 목적격' },
  { pali: 'kaṅkehi', pronKo: '깡게히', meaning: '왜가리에 의해', grammar: '남성 복수 조격 (kaṅka)' },
  { pali: 'vā', pronKo: '와-', meaning: '또는', grammar: '불변어(접속사)' },
  { pali: 'khajjamānaṃ', pronKo: '캇자마-낭', meaning: '먹히고 있는', grammar: '현재수동분사 중성 단수 목적격' },
  { pali: 'sunakhehi', pronKo: '수나게히', meaning: '개에 의해', grammar: '남성 복수 조격 (sunakha)' },
  { pali: 'vā', pronKo: '와-', meaning: '또는', grammar: '불변어(접속사)' },
  { pali: 'khajjamānaṃ', pronKo: '캇자마-낭', meaning: '먹히고 있는', grammar: '현재수동분사 중성 단수 목적격' },
  { pali: 'byagghehi', pronKo: '비앗게히', meaning: '호랑이에 의해', grammar: '남성 복수 조격 (byaggha)' },
  { pali: 'vā', pronKo: '와-', meaning: '또는', grammar: '불변어(접속사)' },
  { pali: 'khajjamānaṃ', pronKo: '캇자마-낭', meaning: '먹히고 있는', grammar: '현재수동분사 중성 단수 목적격' },
  { pali: 'dīpīhi', pronKo: '디-삐-히', meaning: '표범에 의해', grammar: '남성 복수 조격 (dīpī)' },
  { pali: 'vā', pronKo: '와-', meaning: '또는', grammar: '불변어(접속사)' },
  { pali: 'khajjamānaṃ', pronKo: '캇자마-낭', meaning: '먹히고 있는', grammar: '현재수동분사 중성 단수 목적격' },
  { pali: 'siṅgālehi', pronKo: '싱가-레히', meaning: '자칼에 의해', grammar: '남성 복수 조격 (siṅgāla)' },
  { pali: 'vā', pronKo: '와-', meaning: '또는', grammar: '불변어(접속사)' },
  { pali: 'khajjamānaṃ', pronKo: '캇자마-낭', meaning: '먹히고 있는', grammar: '현재수동분사 중성 단수 목적격' },
  { pali: 'vividhehi', pronKo: '위위데히', meaning: '여러 종류의', grammar: '형용사 남성 복수 조격 (vividha)' },
  { pali: 'vā', pronKo: '와-', meaning: '또는', grammar: '불변어(접속사)' },
  { pali: 'pāṇakajātehi', pronKo: '빠-나까자-떼히', meaning: '벌레 종류에 의해', grammar: '남성 복수 조격 (pāṇaka + jāta)' },
  { pali: 'khajjamānaṃ', pronKo: '캇자마-낭', meaning: '먹히고 있는', grammar: '현재수동분사 중성 단수 목적격' },
  // 비교문 (둘째)
  { pali: 'So', pronKo: '소', meaning: '그는', grammar: '지시대명사 남성 단수 주격' },
  { pali: 'imameva', pronKo: '이마메와', meaning: '바로 이', grammar: 'imaṃ + eva' },
...
export const VERSE_15 = {
  ...
  grammarNotes: [
    ...
    '핵심 문법: aṭṭhikāni = 중성 복수 주격("뼈들"). apagatasambandhāni = 연결이 떨어진(복수). aññena = "다른 곳에"(조격)',
...
export const VERSE_15_WORDS: VerseWord[] = [
  ...
  // 뼈 13부위 (aññena 반복)
  { pali: 'aññena', pronKo: '안녜나', meaning: '다른 곳에', grammar: '대명사 남성 단수 조격' },
