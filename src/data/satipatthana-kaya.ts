...
export const VERSE_1 = {
  ...
  grammarNotes: [
    '문장 구조: 「Ekāyano ayaṃ maggo(주어+술어) + 소유격 명사 + 간접목적격 목적구 5개 나열 + yadidaṃ cattāro satipaṭṭhānā(동격 보충설명)」',
    '핵심 문법: 간접목적격(-āya)이 목적("~을 위하여")을 나타내는 용법이 5회 반복 — visuddhiyā, samatikkamāya, atthaṅgamāya, adhigamāya, sacchikiriyāya',
...
export const VERSE_1_WORDS: VerseWord[] = [
  ...
  { pali: 'bhikkhave', pronKo: '빅카웨', meaning: '비구들이여', grammar: '남성 복수 부름격' },
  ...
  { pali: 'visuddhiyā', pronKo: '위숫디야-', meaning: '청정을 위해', grammar: '여성 단수 간접목적격 (visuddhi)', important: true },
  { pali: 'sokaparidevānaṃ', pronKo: '소까빠리데와-낭', meaning: '슬픔과 비탄의', grammar: '남성 복수 소유격 (soka + parideva)' },
  { pali: 'samatikkamāya', pronKo: '사마띡까마-야', meaning: '극복하기 위해', grammar: '남성 단수 간접목적격 (sam + atikkama)' },
  { pali: 'dukkhadomanassānaṃ', pronKo: '둑카도마낫사-낭', meaning: '괴로움과 근심의', grammar: '중성 복수 소유격 (dukkha + domanassa)' },
  { pali: 'atthaṅgamāya', pronKo: '앗탕가마-야', meaning: '소멸을 위해', grammar: '남성 단수 간접목적격 (attha + gama)' },
  { pali: 'ñāyassa', pronKo: '냐-얏사', meaning: '바른 방법의', grammar: '남성 단수 소유격' },
  { pali: 'adhigamāya', pronKo: '아디가마-야', meaning: '얻기 위해/도달을 위해', grammar: '남성 단수 간접목적격 (adhi + gama)' },
  { pali: 'nibbānassa', pronKo: '닙바-낫사', meaning: '열반의', grammar: '중성 단수 소유격', important: true },
  { pali: 'sacchikiriyāya', pronKo: '삿치끼리야-야', meaning: '실현을 위해', grammar: '여성 단수 간접목적격 (sacchi + kiriyā)' },
...
export const VERSE_5 = {
  ...
  grammarNotes: [
    ...
    '복합어: samudayadhammānupassī = samudaya(생겨남)+dhamma(법)+anupassin(관찰하는), ñāṇamattāya = ñāṇa(앎)+matta(만큼)+간접목적격',
...
export const VERSE_5_WORDS: VerseWord[] = [
  ...
  { pali: 'ñāṇamattāya', pronKo: '냐-나맛따-야', meaning: '앎만을 위해', grammar: '중성 단수 간접목적격 (ñāṇa + matta)', important: true },
  { pali: 'paṭissatimattāya', pronKo: '빠띳사띠맛따-야', meaning: '새김만을 위해', grammar: '여성 단수 간접목적격 (paṭissati + matta)' },
...
export const VERSE_6_WORDS: VerseWord[] = [
  ...
  { pali: 'ñāṇamattāya', pronKo: '냐-나맛따-야', meaning: '앎만을 위해', grammar: '중성 단수 간접목적격' },
  { pali: 'paṭissatimattāya', pronKo: '빠띳사띠맛따-야', meaning: '새김만을 위해', grammar: '여성 단수 간접목적격' },
...
export const VERSE_8 = {
  ...
  grammarNotes: [
    ...
    '핵심 문법: uddhaṃ pādatalā(발바닥부터 위로) + adho kesamatthakā(머리끝부터 아래로) — 분리격(-ā)이 "~부터" 기점을 표시',
...
export const VERSE_8_WORDS: VerseWord[] = [
  ...
  { pali: 'pādatalā', pronKo: '빠-다딸라-', meaning: '발바닥부터', grammar: '남성 단수 분리격 (pāda + tala)' },
  { pali: 'adho', pronKo: '아도', meaning: '아래로', grammar: '불변어(부사)' },
  { pali: 'kesamatthakā', pronKo: '게사맛타까-', meaning: '머리카락 끝부터', grammar: '남성 단수 분리격 (kesa + matthaka)' },
  ...
  // 32신체 나열
  { pali: 'atthi', pronKo: '앗티', meaning: '있다', grammar: '현재 3인칭 단수' },
  { pali: 'imasmiṃ', pronKo: '이마스밍', meaning: '이', grammar: '지시대명사 남성 단수 처격' },
  { pali: 'kāye', pronKo: '까-예', meaning: '몸에', grammar: '남성 단수 처격' },
...
export const VERSE_9_WORDS: VerseWord[] = [
  ...
  { pali: 'kāyaṃ', pronKo: '까-양', meaning: '몸을', grammar: '남성 단수 목적격' },
  { pali: 'uddhaṃ', pronKo: '웃당', meaning: '위로', grammar: '불변어(부사)' },
  { pali: 'pādatalā', pronKo: '빠-다딸라-', meaning: '발바닥부터', grammar: '남성 단수 분리격' },
  { pali: 'adho', pronKo: '아도', meaning: '아래로', grammar: '불변어(부사)' },
  { pali: 'kesamatthakā', pronKo: '게사맛타까-', meaning: '머리카락 끝부터', grammar: '남성 단수 분리격' },
  ...
  { pali: 'atthi', pronKo: '앗티', meaning: '있다', grammar: '현재 3인칭 단수' },
  { pali: 'imasmiṃ', pronKo: '이마스밍', meaning: '이', grammar: '지시대명사 처격' },
  { pali: 'kāye', pronKo: '까-예', meaning: '몸에', grammar: '남성 단수 처격' },
...
export const VERSE_10 = {
  ...
  grammarNotes: [
    ...
    '핵심 문법: yathāṭhitaṃ = yathā(~처럼)+ṭhita(놓인), yathāpaṇihitaṃ = yathā+paṇihita(배치된). dhātuso = dhātu(요소)+분리격 부사("요소별로")',
...
export const VERSE_10_WORDS: VerseWord[] = [
  ...
  { pali: 'dhātuso', pronKo: '다-뚜소', meaning: '요소별로', grammar: '여성 분리격/부사 (dhātu + so)', important: true },
  { pali: 'paccavekkhati', pronKo: '빳짜웩카띠', meaning: '관찰한다', grammar: '현재 3인칭 단수' },
  // 4대 요소
  { pali: 'atthi', pronKo: '앗티', meaning: '있다', grammar: '현재 3인칭 단수' },
  { pali: 'imasmiṃ', pronKo: '이마스밍', meaning: '이', grammar: '지시대명사 처격' },
...
export const VERSE_11_WORDS: VerseWord[] = [
  ...
  { pali: 'dhātuso', pronKo: '다-뚜소', meaning: '요소별로', grammar: '여성 분리격/부사' },
  { pali: 'paccavekkhati', pronKo: '빳짜웩카띠', meaning: '관찰한다', grammar: '현재 3인칭 단수' },
  { pali: 'atthi', pronKo: '앗티', meaning: '있다', grammar: '현재 3인칭 단수' },
  { pali: 'imasmiṃ', pronKo: '이마스밍', meaning: '이', grammar: '지시대명사 처격' },
  { pali: 'kāye', pronKo: '까-예', meaning: '몸에', grammar: '남성 단수 처격' },
...
export const VERSE_13 = {
  ...
  grammarNotes: [
    ...
    '핵심 문법: khajjamānaṃ = 현재수동분사("먹히고 있는", khādati). 도구격(-ehi)이 행위자("~에 의해") 표시',
...
export const VERSE_13_WORDS: VerseWord[] = [
  ...
  { pali: 'sivathikāya', pronKo: '시와티까-야', meaning: '묘지에서', grammar: '여성 단수 처격' },
  { pali: 'chaḍḍitaṃ', pronKo: '찻디땅', meaning: '버려진', grammar: '과거분사 중성 단수 목적격' },
  // 동물 8종 + 벌레
  { pali: 'kākehi', pronKo: '까-게히', meaning: '까마귀에 의해', grammar: '남성 복수 도구격 (kāka)', important: true },
  { pali: 'vā', pronKo: '와-', meaning: '또는', grammar: '불변어(접속사)' },
  { pali: 'khajjamānaṃ', pronKo: '캇자마-낭', meaning: '먹히고 있는', grammar: '현재수동분사 중성 단수 목적격 (khādati)', important: true },
  { pali: 'kulalehi', pronKo: '꿀라레히', meaning: '매에 의해', grammar: '남성 복수 도구격 (kulala)' },
  { pali: 'vā', pronKo: '와-', meaning: '또는', grammar: '불변어(접속사)' },
  { pali: 'khajjamānaṃ', pronKo: '캇자마-낭', meaning: '먹히고 있는', grammar: '현재수동분사 중성 단수 목적격' },
  { pali: 'gijjhehi', pronKo: '긷제히', meaning: '독수리에 의해', grammar: '남성 복수 도구격 (gijjha)' },
  { pali: 'vā', pronKo: '와-', meaning: '또는', grammar: '불변어(접속사)' },
  { pali: 'khajjamānaṃ', pronKo: '캇자마-낭', meaning: '먹히고 있는', grammar: '현재수동분사 중성 단수 목적격' },
  { pali: 'kaṅkehi', pronKo: '깡게히', meaning: '왜가리에 의해', grammar: '남성 복수 도구격 (kaṅka)' },
  { pali: 'vā', pronKo: '와-', meaning: '또는', grammar: '불변어(접속사)' },
  { pali: 'khajjamānaṃ', pronKo: '캇자마-낭', meaning: '먹히고 있는', grammar: '현재수동분사 중성 단수 목적격' },
  { pali: 'sunakhehi', pronKo: '수나게히', meaning: '개에 의해', grammar: '남성 복수 도구격 (sunakha)' },
  { pali: 'vā', pronKo: '와-', meaning: '또는', grammar: '불변어(접속사)' },
  { pali: 'khajjamānaṃ', pronKo: '캇자마-낭', meaning: '먹히고 있는', grammar: '현재수동분사 중성 단수 목적격' },
  { pali: 'byagghehi', pronKo: '비앗게히', meaning: '호랑이에 의해', grammar: '남성 복수 도구격 (byaggha)' },
  { pali: 'vā', pronKo: '와-', meaning: '또는', grammar: '불변어(접속사)' },
  { pali: 'khajjamānaṃ', pronKo: '캇자마-낭', meaning: '먹히고 있는', grammar: '현재수동분사 중성 단수 목적격' },
  { pali: 'dīpīhi', pronKo: '디-삐-히', meaning: '표범에 의해', grammar: '남성 복수 도구격 (dīpī)' },
  { pali: 'vā', pronKo: '와-', meaning: '또는', grammar: '불변어(접속사)' },
  { pali: 'khajjamānaṃ', pronKo: '캇자마-낭', meaning: '먹히고 있는', grammar: '현재수동분사 중성 단수 목적격' },
  { pali: 'siṅgālehi', pronKo: '싱가-레히', meaning: '자칼에 의해', grammar: '남성 복수 도구격 (siṅgāla)' },
  { pali: 'vā', pronKo: '와-', meaning: '또는', grammar: '불변어(접속사)' },
  { pali: 'khajjamānaṃ', pronKo: '캇자마-낭', meaning: '먹히고 있는', grammar: '현재수동분사 중성 단수 목적격' },
  { pali: 'vividhehi', pronKo: '위위데히', meaning: '여러 종류의', grammar: '형용사 남성 복수 도구격 (vividha)' },
  { pali: 'vā', pronKo: '와-', meaning: '또는', grammar: '불변어(접속사)' },
  { pali: 'pāṇakajātehi', pronKo: '빠-나까자-떼히', meaning: '벌레 종류에 의해', grammar: '남성 복수 도구격 (pāṇaka + jāta)' },
  { pali: 'khajjamānaṃ', pronKo: '캇자마-낭', meaning: '먹히고 있는', grammar: '현재수동분사 중성 단수 목적격' },
  // 비교문 (둘째)
  { pali: 'So', pronKo: '소', meaning: '그는', grammar: '지시대명사 남성 단수 주격' },
  { pali: 'imameva', pronKo: '이마메와', meaning: '바로 이', grammar: 'imaṃ + eva' },
...
export const VERSE_15 = {
  ...
  grammarNotes: [
    ...
    '핵심 문법: aṭṭhikāni = 중성 복수 주격("뼈들"). apagatasambandhāni = 연결이 떨어진(복수). aññena = "다른 곳에"(도구격)',
...
export const VERSE_15_WORDS: VerseWord[] = [
  ...
  // 뼈 13부위 (aññena 반복)
  { pali: 'aññena', pronKo: '안녜나', meaning: '다른 곳에', grammar: '대명사 남성 단수 도구격' },
