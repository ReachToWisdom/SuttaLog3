...
export const VERSE_4_WORDS: VerseWord[] = [
  ...
  { pali: 'dīghaṃ', pronKo: '디-강', meaning: '길게', grammar: '형용사 중성 단수 대격/부사적' },
  ...
  { pali: 'rassaṃ', pronKo: '랏상', meaning: '짧게', grammar: '형용사 중성 단수 대격/부사적' },
  { pali: 'assasāmīti', pronKo: '앗사사-미-띠', meaning: '"들이쉰다"라고', grammar: '현재 1인칭 단수 + iti' },
  { pali: 'pajānāti', pronKo: '빠자-나-띠', meaning: '알아차린다', grammar: '현재 3인칭 단수' },
  // 2행: 짧게 내쉬면서
  { pali: 'rassaṃ', pronKo: '랏상', meaning: '짧게', grammar: '형용사 중성 단수 대격/부사적' },
  ...
  { pali: 'kāyasaṅkhāraṃ', pronKo: '까-야상카-랑', meaning: '몸의 형성을', grammar: '남성 단수 대격' },
  { pali: 'passasissāmīti', pronKo: '빳사싯사-미-띠', meaning: '"내쉬리라"라고', grammar: '미래 1인칭 단수 + iti' },
  { pali: 'sikkhati', pronKo: '식카띠', meaning: '훈련한다', grammar: '현재 3인칭 단수' },
]
...
export const VERSE_6_WORDS: VerseWord[] = [
  ...
  { pali: 'kāyoti', pronKo: '까-요띠', meaning: '"몸이"라고', grammar: '남성 단수 주격 + iti' },
  { pali: 'vā', pronKo: '와-', meaning: '또는', grammar: '불변어(접속사)' },
  { pali: 'panassa', pronKo: '빠낫사', meaning: '그에게', grammar: '불변어+대명사 속격' },
...
export const VERSE_9_WORDS: VerseWord[] = [
  ...
  { pali: 'tacapariyantaṃ', pronKo: '따짜빠리얀땅', meaning: '피부를 경계로 한', grammar: '형용사 남성 단수 대격' },
  { pali: 'pūraṃ', pronKo: '뿌-랑', meaning: '가득 찬', grammar: '형용사 남성 단수 대격' },
  { pali: 'nānappakārassa', pronKo: '나-납빠까-랏사', meaning: '여러 종류의', grammar: '형용사 남성 단수 속격' },
  { pali: 'asucino', pronKo: '아수찌노', meaning: '부정한 것의', grammar: '형용사 남성 단수 속격' },
...
export const VERSE_13_WORDS: VerseWord[] = [
  ...
  { pali: 'sarīraṃ', pronKo: '사리-랑', meaning: '시체를', grammar: '중성 단수 대격' },
  { pali: 'sivathikāya', pronKo: '시와티까-야', meaning: '묘지에서', grammar: '여성 단수 처격' },
  { pali: 'chaḍḍitaṃ', pronKo: '찻디땅', meaning: '버려진', grammar: '과거분사 중성 단수 대격' },
  // 동물 8종 + 벌레
  ...
  { pali: 'vā', pronKo: '와-', meaning: '또는', grammar: '불변어(접속사)' },
  { pali: 'khajjamānaṃ', pronKo: '캇자마-낭', meaning: '먹히고 있는', grammar: '현재수동분사 중성 단수 대격' },
